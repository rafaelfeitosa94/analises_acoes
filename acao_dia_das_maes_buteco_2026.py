...
# Título principal
st.markdown("""
<h1 style="font-size: 2.5rem; color: #003366; font-weight: bold; margin-bottom: 0.5rem; text-shadow: 2px 2px 4px rgba(0,51,102,0.1); text-align: center;">🌹 Dia das Mães Buteco 2026 🌹</h1>
""", unsafe_allow_html=True)

# Subtítulo
st.markdown("""
<div style="display: flex; justify-content: center; width: 100%; margin-top: 0.5rem;">
    <p style="background: linear-gradient(135deg, #003366 0%, #1a4d80 100%); color: white; font-weight: bold; font-size: 1.2rem; padding: 0.8rem 2rem; border-radius: 50px; box-shadow: 0 4px 10px rgba(0,51,102,0.3); margin: 0; display: inline-block; text-align: center;">De 08 à 10/05/2026 x 09 à 11/05/2025</p>
</div>
""", unsafe_allow_html=True)
