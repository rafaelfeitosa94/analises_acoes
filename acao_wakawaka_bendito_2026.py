...
st.set_page_config(
    page_title="Combo Waka Waka Bendito 🐺",
    page_icon="🐺",
    layout="wide",
...
USERS = {
    ...
    "gerente": hashlib.sha256("bendito1234".encode()).hexdigest(),
...
def main_dashboard():
    ...
    # Título principal
    st.markdown("""
    <h1 style="font-size: 2.5rem; color: #96c734; font-weight: bold; margin-bottom: 0.5rem; text-shadow: 2px 2px 4px rgba(150,199,52,0.1); text-align: center;">🍪 Combo Waka waka Bendito 2026 🍪</h1>
    """, unsafe_allow_html=True)
    
    # Subtítulo
    st.markdown("""
    <div style="display: flex; justify-content: center; width: 100%; margin-top: 0.5rem;">
        <p style="background: linear-gradient(135deg, #5a8a1e 0%, #96c734 100%); color: white; font-weight: bold; font-size: 1.2rem; padding: 0.8rem 2rem; border-radius: 50px; box-shadow: 0 4px 10px rgba(150,199,52,0.3); margin: 0; display: inline-block; text-align: center;">Comparativo 27/04 à 03/05/2026 x 28/05 à 04/06/2025</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    data = {
        'MARCA': ['BENDITO'] * 2,
        'LOJA': ['BEN BARÃO', 'BEN LEBLON'],
        'FAT_2026': [29374.81, 21879.67],
        'TC_2026': [699, 600],
        'TM_2026': [42.024048640915595, 36.466116666666665],
        'FAT_2025': [28820.8, 28319.99],
        'TC_2025': [769, 718],
        'TM_2025': [37.478283485045516, 39.442883008356546],
        'PROD_PROMOCIONADO': ['COMBO WAKA WAKA', 'COMBO WAKA WAKA'],
        'COMPOSICAO_PROD': ['1 Espresso pequeno + 1 Pão de Queijo Grande + 1 Brigadeiro', '1 Espresso pequeno + 1 Pão de Queijo Grande + 1 Brigadeiro'],
        'QUANTIDADE': [6, 2],
        'VALOR_VENDA_PROD': [155.28, 51.76],
        'PART.(%)': [0.005286161850919206, 0.0023656663925918447]
    }
