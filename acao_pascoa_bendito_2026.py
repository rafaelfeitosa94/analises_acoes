...
USERS = {
    ...
    "bendito": hashlib.sha256("pascoa2026".encode()).hexdigest(),
...
def login_screen():
    ...
    with st.container():
        ...
        st.markdown('<div class="login-title">🐰 PÁSCOA BENDITO 🥕</div>', unsafe_allow_html=True)
...
def main_dashboard():
    ...
    # Título principal
    st.markdown("""
    <h1 style="font-size: 2.5rem; color: #96c734; font-weight: bold; margin-bottom: 0.5rem; text-shadow: 2px 2px 4px rgba(150,199,52,0.1); text-align: center;">🐰 PÁSCOA BENDITO 2026 🥕</h1>
    """, unsafe_allow_html=True)
    
    # Subtítulo
    st.markdown("""
    <div style="display: flex; justify-content: center; width: 100%; margin-top: 0.5rem;">
        <p style="background: linear-gradient(135deg, #5a8a1e 0%, #96c734 100%); color: white; font-weight: bold; font-size: 1.2rem; padding: 0.8rem 2rem; border-radius: 50px; box-shadow: 0 4px 10px rgba(150,199,52,0.3); margin: 0; display: inline-block; text-align: center;">23/03/2026 À 05/04/2026 X 07/04/2025 À 20/04/2025</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    data = {
        'MARCA': ['BENDITO'] * 4,
        'LOJA': [
            'BEN BARÃO', 'BEN BARRA SHOPPING', 'BEN DOWNTOWN', 'BEN LEBLON'
        ],
        'FAT_2026': [59569.8, 63031.5, 26099.66, 45038.1],
        'TC_2026': [1482, 1808, 535, 1211],
        'TM_2026': [40.19554655870446, 34.86255530973451, 48.78441121495327, 37.19083402146986],
        'FAT_2025': [51082.31, 61281.85, 31599.58, 48875.88],
        'TC_2025': [1383, 1885, 627, 1238],
        'TM_2025': [36.93587129428778, 32.51026525198939, 50.39805422647528, 39.47970920840064],
        'PROD_PROMOCIONADO': ['AÇÃO DE PÁSCOA'] * 4,
        'QUANTIDADE_BOTÃO': [38, 8, 30, 41],
        'CAIXA C/ 4 BRIGADEIROS': [0, 0, 0, 1],
        'BOMBOM CX 6 UNI': [3, 0, 1, 0],
        'CAIXA C/ 6 OVO DE GALINHA': [9, 3, 4, 7],
        'CAIXA C/6 BRIGADEIROS': [1, 0, 2, 4],
        'OVO DE GALINHA UND': [25, 2, 20, 24],
        'BOLO DE CENOURA FORMA COELHO': [0, 3, 3, 5],
        'COMPOSICAO_PROD': ['ITENS DE PÁSCOA'] * 4,
        'QUANTIDADE': [38, 8, 30, 41],
        'VALOR_VENDA_PROD': [2091.0899999999997, 735.5, 1533.3999999999999, 2304.5999999999995],
        'PART.(%)': [0.03510318987137777, 0.01166876879020807, 0.058751723202524475, 0.051170009392048056]
    }
