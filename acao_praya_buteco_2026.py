...
# Título principal
st.markdown("""
<h1 style="font-size: 2.5rem; color: #003366; font-weight: bold; margin-bottom: 0.5rem; text-shadow: 2px 2px 4px rgba(0,51,102,0.1); text-align: center;">🧜‍♀️AÇÃO PRAYA BUTECO 2026🏖️</h1>
""", unsafe_allow_html=True)
...
# Dados fornecidos
data = {
    'MARCA': ['BUTECO', 'BUTECO', 'BUTECO', 'BUTECO'],
    'LOJA': ['BUT CIDADE JARDIM', 'BUT BOTAFOGO', 'BUT OLEGÁRIO', 'BUT RIO 2'],
    'FAT_2026': [109799.07, 70329.26, 141413.78, 102156.09],
    'TC_2026': [1650, 1450, 1812, 1705],
    'TM_2026': [66.54489090909091, 48.50293793103448, 78.04292494481236, 59.91559530791789],
    'FAT_2025': [145336.13, 83842.22, 183278.73, 103842.22],
    'TC_2025': [2012, 2202, 2638, 1915],
    'TM_2025': [72.23465705765408, 38.07548592188919, 69.47639499620925, 54.22570234986945],
    'PROD_PROMOCIONADO': ['AÇÃO PRAYA PAGUE 5 LEVE 6'] * 4,
    'COMPOSICAO_PROD': ['LONG NECK PRAYA'] * 4,
    'QUANTIDADE': [20, 7, 7, 2],
    'VALOR_VENDA_PROD': [1464, 432, 492, 192],
    'PART.(%)': [0.01333344626689461, 0.006142535837857529, 0.0034791517488606837, 0.0018794767889021595]
}
