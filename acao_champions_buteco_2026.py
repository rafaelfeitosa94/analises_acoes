...
st.set_page_config(
    page_title="Champions League Buteco 2026",
    page_icon="🏆",
    layout="wide",
...
data = {
    'MARCA': ['BUTECO'] * 8,
    'LOJA': [
        'BUT FREGUESIA', 'BUT OLEGÁRIO', 'BUT CIDADE JARDIM', 'BUT ICARAÍ',
        'BUT RIO 2', 'BUT BARRA SUL', 'BUT BOTAFOGO', 'BUT MOEMA'
    ],
    'FAT_2026': [146944.56, 93777.79, 92446.60, 73461.23, 65333.56, 55536.47, 53616.79, 34616.36],
    'TC_2026': [929, 1190, 1407, 1029, 1416, 1081, 1026, 716],
    'TM_2026': [
        158.17498385360602, 78.80486554621848, 65.70476190476191, 71.39089407191447,
        46.1395197740113, 51.37508788159112, 52.25807992202729, 48.34687150837989
    ],
    'FAT_2025': [188589.61, 98401.63, 118193.54, 92312.48, 54765.75, 45209.53, 69292.91, 105040.42],
    'TC_2025': [1939, 1381, 1741, 2195, 831, 796, 978, 1774],
    'TM_2025': [
        97.26127385250128, 71.25389572773354, 67.88830557151063, 42.05579954441913,
        65.90342960288808, 56.79589195979899, 70.85164621676891, 59.21105975197294
    ],
    'PROD_PROMOCIONADO': ['CHAMPIONS LEAGUE BALDE 4 POR 3'] * 8,
    'COMPOSICAO_PROD': ['HEINEKEN 600ML'] * 8,
    'QUANTIDADE': [89, 51, 59, 0, 30, 42, 39, 38],
    'HNK 600ML TOTAIS': [107, 40, 87, 79, 169, 222, 555, 252],
    'VALOR_VENDA_PROD': [5073, 2907, 3363, 0, 3211, 4218, 10545, 4788],
    'PART.(%)': [
        0.03452322426907128, 0.03099881112574737, 0.0363777575378651, 0.0,
        0.04914778867093727, 0.07595009189456946, 0.19667346739705976, 0.13831610255959897
    ]
}
